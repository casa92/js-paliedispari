...
let evenOrOdd = evenOroddInputValidator(prompt( 'scegli pari o dispari' ));

function evenOroddInputValidator(userChoiceInput) {
...
let winnerOrLoser;
if ( evenOrOdd === finalSumIsEvenOrOdd ) {
...
Dato che la somma è ${finalSum} e la tua scelta iniziziale è stata ${evenOrOdd}, ${winnerOrLoser}!
`;
